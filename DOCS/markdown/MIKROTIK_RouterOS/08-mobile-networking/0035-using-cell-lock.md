...
Property Description<br>phy-cellid  (integer; Default: ) Physical Cell Identification (PCI) of currently used cell tower.<br>earfcn  (integer; Default: ) Absolute Radio Frequency Channel Number<br>**----- End of picture text -----**<br>
