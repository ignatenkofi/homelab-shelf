...
**==> picture [504 x 131] intentionally omitted <==**

**==> picture [516 x 32] intentionally omitted <==**

**----- Start of picture text -----**<br>
If you are not sure how exactly configure your gateway device, please reach MikroTik's official consultants for configuration support.<br>**----- End of picture text -----**<br>
