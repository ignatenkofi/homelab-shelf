...
Choose SSID, Password, frequency and choose bridge mode option that will act as a bridge for the setup, please see the example. Enable 5Ghz interface after required parameters have been set. 
