...
Choose SSID, Password, frequency and choose bridge mode option that will act as ap-bridge for the setup, please see the example. Enable W60G interface after required parameters have been set. 
